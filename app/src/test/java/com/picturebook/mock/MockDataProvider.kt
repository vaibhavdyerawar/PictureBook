...
class MockDataProvider {
    ...
    companion object {
        fun createZeroImage(): SearchItemsData {
        ...
        fun createImages(): SearchItemsData {
            return SearchItemsData(
                total = 1,
                totalHits = 1,
                itemsList = createImageResultsList()
            )
        }

        fun fetchImages(): FetchImageData {
